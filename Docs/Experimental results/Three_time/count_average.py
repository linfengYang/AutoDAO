...
folder_path = "../three_time/EoH_with_next_load_R1"
gap_power_rates = []
gap_price_rates = []
...
# folder_path = "../three_time/LLM4RUC_with_next_load_R1"
#
#
#
...
#     print(f"Processing {len(gap_power_rates)} records")
#     print(f"gap_power_rate average: {avg_gap_power}")
#     print(f"gap_price_rate average: {avg_gap_price}")
...
#################################Average values of three algorithms on different scales#######################
# import json
# import os
# from collections import defaultdict


# files = ["../three_time/LLM4RUC_with_next_load_R1/run1.json", "../three_time/LLM4RUC_with_next_load_R1/run2.json", "../three_time/LLM4RUC_with_next_load_R1/run3.json"]
...
# with open("../three_time/LLM4RUC_with_next_load_R1/average_result.json", "w") as f:
